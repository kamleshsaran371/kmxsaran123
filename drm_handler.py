                ...
                if m.text:
                    ...
                    if topic == "/yes":
                        ...
                        if caption == "/cc1":
                            ...
                            cc = f"——— ✦ {str(count).zfill(3)} ✦ ———\n\n<b>📝 Tɪᴛʟᴇ : ➤ </b> {name1}\n<b>├── Eᴜᴛᴇɴsɪᴏɴ : ➤  {CR} .mkv</b>\n<b>├── Resolution : [{res}]</b>\n<blockquote><b>🧿 Bᴀᴛᴄʜ Nᴀᴍᴇ : ➤ {b_name}</b></blockquote>\n\n**📥 Eᴛʀᴀᴄᴛᴇᴅ Bʏ : ➤ {CR}\n\n**━━━━━✦🧡kmx🧡✦━━━━━━**"
                            cc1 = f"——— ✦ {str(count).zfill(3)} ✦ ———\n\n<b>📁 Title :</b> {name1}\n<b>├── Eᴜᴛᴇɴsɪᴏɴ : ➤  {CR} .pdf</b>\n<blockquote><b>🧿 Bᴀᴛᴄʜ Nᴀᴍᴇ : ➤ {b_name}</b></blockquote>\n\n**📥 Eᴛʀᴀᴄᴛᴇᴅ Bʏ : ➤ {CR}\n\n**━━━━━✦🧡kmx🧡✦━━━━━━**"
                            cczip = f"——— ✦ {str(count).zfill(3)} ✦ ———\n\n<b>📒 Title :</b> {name1}\n<b>├── Eᴜᴛᴇɴsɪᴏɴ : ➤ {CR} .zip</b>\n<blockquote><b>🧿 Bᴀᴛᴄʜ Nᴀᴍᴇ : ➤ {b_name}</b></blockquote>\n\n**📥 Eᴛʀᴀᴄᴛᴇᴅ Bʏ : ➤ {CR}\n\n**━━━━━✦🧡kmx🧡✦━━━━━━**"
                            ccimg = f"——— ✦ {str(count).zfill(3)} ✦ ———\n\n<b>🖼️ Title :</b> {name1}\n<b>├── Eᴜᴛᴇɴsɪᴏɴ : ➤  {CR} .jpg</b>\n<blockquote><b>🧿 Bᴀᴛᴄʜ Nᴀᴍᴇ : ➤ {b_name}</b></blockquote>\n\n**📥 Eᴛʀᴀᴄᴛᴇᴅ Bʏ : ➤ {CR}\n\n**━━━━━✦🧡kmx🧡✦━━━━━━**"
                            ccm = f"——— ✦ {str(count).zfill(3)} ✦ ———\n\n<b>🎵 Title :</b> {name1}\n<b>├── Eᴜᴛᴇɴsɪᴏɴ : ➤ {CR} .mp3</b>\n<blockquote><b>🧿 Bᴀᴛᴄʜ Nᴀᴍᴇ : ➤ {b_name}</b></blockquote>\n\n**📥 Eᴛʀᴀᴄᴛᴇᴅ Bʏ : ➤ {CR}\n\n**━━━━━✦🧡kmx🧡✦━━━━━━**"
                            cchtml = f"——— ✦ {str(count).zfill(3)} ✦ ———\n\n<b>🌐 Title :</b> {name1}\n<b>├── Eᴜᴛᴇɴsɪᴏɴ : ➤  {CR} .html</b>\n<blockquote><b>🧿 Bᴀᴛᴄʜ Nᴀᴍᴇ : ➤ {b_name}</b></blockquote>\n\n**📥 Eᴛʀᴀᴄᴛᴇᴅ Bʏ : ➤ {CR}\n\n**━━━━━✦🧡kmx🧡✦━━━━━━**"
                        else:
